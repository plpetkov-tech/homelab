...
usage() {
  ...
  echo ""
  echo "Upgrades the addons (cilium, kubelet-serving-cert-approver, local-path-provisioner, metrics-server, cilium-lb) to the versions specified in your environment settings"
}
